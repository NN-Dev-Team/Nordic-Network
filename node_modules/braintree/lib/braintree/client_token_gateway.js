...
var ClientTokenGateway, DEFAULT_VERSION, ErrorResponse, Gateway, Util, deprecate, exceptions,
...
ClientTokenGateway = (function(_super) {
  ...
  ClientTokenGateway.prototype.generate = function(params, callback) {
    ...
    Util.verifyKeys(this._generateSignature(), params, deprecate);
  ...
  ClientTokenGateway.prototype._generateSignature = function() {
    return {
      valid: ["addressId", "customerId", "proxyMerchantId", "merchantAccountId", "version", "sepaMandateAcceptanceLocation", "sepaMandateType", "options", "options[makeDefault]", "options[verifyCard]", "options[failOnDuplicatePaymentMethod]"]
    };
  };
