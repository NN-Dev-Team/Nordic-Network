...
Util = (function() {
  ...
  Util.verifyKeys = function(keys, obj, deprecate) {
    var invalidKeys, unrecognizedKeys;
    unrecognizedKeys = this.without(this.flattenKeys(obj), keys.valid);
    if (keys.ignore) {
      invalidKeys = unrecognizedKeys.filter(function(key) {
        var ignoredKey, _i, _len, _ref;
        _ref = keys.ignore;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ignoredKey = _ref[_i];
          if (key.indexOf(ignoredKey) === 0) {
            return false;
          }
        }
        return true;
