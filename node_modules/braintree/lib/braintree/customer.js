...
var AmexExpressCheckoutCard, AndroidPayCard, ApplePayCard, AttributeSetter, CoinbaseAccount, CreditCard, Customer, PayPalAccount, UsBankAccount, VenmoAccount,
...
Customer = (function(_super) {
  ...
  function Customer(attributes) {
    var cardAttributes, coinbaseAccountAttributes, paypalAccountAttributes, usBankAccountAttributes, venmoAccountAttributes;
    ...
    if (attributes.usBankAccounts) {
      this.usBankAccounts = (function() {
        var _i, _len, _ref, _results;
        _ref = attributes.usBankAccounts;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          usBankAccountAttributes = _ref[_i];
          _results.push(new UsBankAccount(usBankAccountAttributes));
        }
        return _results;
      })();
