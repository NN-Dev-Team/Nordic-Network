...
<head> 
    ...
    <title>Nordic Network - The Nordic Way.</title>
    <meta charset="utf-8">
...
<nav id="nav-nomargin" class="navbar navbar-default navbar-fixed-top">
  ...
  <div class="col-sm-4"><a href="https://github.com/NN-Dev-Team/Nordic-Network"><img id="feature-img" class="center-block" src="pics/Icons/github.png" height="50px" width="50px"><h4 id="feature-text-title"></a>Github</h4><p id="feature-text" class="center-block">Our code is open source on GitHub</p></div>
        </div>
   ...
   |:: `-------' ::|
    ...
    <br />
  <div class="row">
  <div class="col-sm-3"><img id="pricing-img" class="center-block img-circle" src="pics/icons/bulb_lg.png" height="100px" width="100px"><h4 id="pricing-text-title">Baldur</h4><p id="pricing-text" class="center-block"><b>Weekly cost:</b> Free</p><p id="pricing-text" class="center-block"><b>Features:</b> 256 MB RAM & 1 GB disk space</p></div>
                            
  <div class="col-sm-3"><img id="pricing-img" class="center-block img-circle" src="pics/icons/fire.svg" alt="fire" align="middle" height="100px" width="100px"><h4 id="pricing-text-title">Loki</h4><p id="pricing-text" class="center-block"><b>Weekly cost:</b> Free</p><p id="pricing-text" class="center-block"><b>Features:</b> 512 MB RAM, 2 GB disk space & FTP access</p></div>
   ...
   <div class="col-sm-3"><img id="pricing-img" class="center-block img-circle" src="pics/icons/bolt.svg" height="100px" width="100px"><h4 id="pricing-text-title">Thor</h4><p id="pricing-text" class="center-block"><b>Weekly cost:</b> £0,4 <b>OR</b> x votes</p><p id="pricing-text" class="center-block"><b>Features:</b> 1 GB RAM, 4 GB disk space & FTP access</p><p id="pricing-text" class="center-block"><b>Monthly cost:</b> £2</p><p id="pricing-text" class="center-block"><b>Premium features:</b> No advertisements on this website</p></div>
    ...
    <footer id="footer">
            ...
            <p id="center-text-footer">© Copyright 2016 Nordic Network | Picture provided with <span class="glyphicon glyphicon-heart"></span> by <a href="http://www.gratisography.com">Gratisography</a> | Icons by <a href="http://google.github.io/material-design-icons">Google</a> and <a href="http://www.useiconic.com/open">Iconic Open</a> | GitHub logo by <a href="http://www.github.com/logos">GitHub</a></p>
...
\_\ \/ \___/|_|  \__,_|_|\___| \_\ \/ \___|\__| \_/\_/ \___/|_|  |_|\_\
                 Hosting Servers, The Nordic Way.
                                                                        -->
