     ...
     ':::::::::::'
		...
		<div id="pricing" class="container-fluid">
			...
			<div class="row" id="pricing-row">
				<div class="col-sm-2 pricing-box-free"><img id="pricing-img" class="center-block img-circle" src="/pics/icons/bulb_lg.png" height="100px" width="100px"><h3 id="pricing-text-title">Baldur</h3><p class="pricing-text center-block">256 MB RAM</p><p class="pricing-text pricing-text-bottom center-block">1 GB SSD</p><h3 class="pricing-price">£0.5 / month</h3></div>
				...
				<div class="col-sm-2 pricing-box-premium"><img id="pricing-img" class="center-block img-circle" src="/pics/icons/bolt.svg" height="100px" width="100px"><h3 id="pricing-text-title">Thor</h3><p class="pricing-text center-block">1 GB RAM</p><p class="pricing-text center-block">4 GB SSD</p><p class="pricing-text center-block">FTP</p><p class="pricing-text pricing-text-bottom center-block"><b>No advertisements</b></p><h3 class="pricing-price">£2 / month</h3></div>
                
				<div class="col-sm-2 pricing-box-premium"><img id="pricing-img" class="center-block img-circle" src="/pics/icons/face-lg.png" height="100px" width="100px"><h3 id="pricing-text-title">Odin</h3><p class="pricing-text center-block">2 GB RAM</p><p class="pricing-text center-block">8 GB SSD</p><p class="pricing-text center-block">FTP</p><p class="pricing-text center-block"><b>No advertisements</b></p><p class="pricing-text pricing-text-bottom center-block"><b>Your own forum</b></p><h3 class="pricing-price">£4 / month</h3></div>                           
			</div>
			<br />
			<br />
